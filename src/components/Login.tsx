    ...
    <div className="container-fluid">
        <div className="row justify-content-center d-flex align-items-center" style={{height:"100vh"}}>
            <div className="logo-float" >
                ...
                <img src="/images/general/union.png" className="logo-float_sqr" alt="unionlogo" />
                <img src="/images/general/lendsqr.png" className="logo-float_wri" alt="lendsqrlogo" />
                        ...
                        <div className="form-main">
                            <div className="form-main_text pb-5 mb-3">
                                <div className="pb-2">
                                    ...
                                    <h3 className="fw-7 text-center fs-40 d-block d-md-none">Welcome!</h3>
                                </div>
                                <div>
                                    <span className="fs-20 d-none d-md-block">Enter details to login</span>
                                    <span className="fs-20 text-center d-block d-md-none">Enter details to login</span>
                                </div>
                            </div>
                            ...
                            <div className="form-sub-container">
                                ...
                                <div className="input-group">
                                    <input type="password" placeholder="Password" className="form-control input-main-type" style={{borderRight:"0"}}/>
